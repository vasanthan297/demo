...
public class AwsClientBuilder {
	...
	/**
	 * Instantiate a builder with the credentials and region specified (using the
	 * {@link Regions} type).
	 *
	 * @param regions
	 *            the region in which to create clients for
	 * @param accessKey
	 *            the access key to use for credentials
	 * @param secretKey
	 *            the secret key to use for credentials
	 */
	 ...
	 *
	 * @param clientClass
	 *            the class of the service client to build
	 *
